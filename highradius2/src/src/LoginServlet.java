...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
{
    ...
    try
    {
        ...
        List<OrderPojo> orderList= OrderDetails.getOrderDetails();
        
 
        if(userValidate.equals("Level_1"))
        {
        ...
        else if(userValidate.equals("Level_2"))
        {
        ...
        else if(userValidate.equals("Level_3"))
        {
